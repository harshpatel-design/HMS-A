          ...
          >
              ...
              <Form.Item label="Address">
                <Row gutter={[12, 12]}>
                  ...
                  <Col span={8}>
                    ...
                    >
                      <Input placeholder="Pincode" disabled={loading} />
                    </Form.Item>
                  </Col>
                </Row>
              </Form.Item>
            ...
            <Panel header="Appointment Schedule" key="appointment">
              <Row gutter={[16, 16]}>
                ...
                <Col span={6}>
                  <Form.Item label="Slot Duration (Minutes)" name="slotDuration" initialValue={15}>
                    <InputNumber min={5} step={5} style={{ width: '100%' }} placeholder="e.g. 15" />
                  </Form.Item>
                </Col>
                <Col span={6}>
                  <Form.Item
                ...
                {(fields, { add, remove }) => (
                  <>
                    {fields.map(({ key, name, ...restField }) => (
                      <Row gutter={15} align="middle" key={key}>
                        <Col span={10}>
